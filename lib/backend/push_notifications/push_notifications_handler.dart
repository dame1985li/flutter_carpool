...
final parametersBuilderMap =
  ...
  'editProfile': (data) async => ParameterData(
        allParams: {
          'userEmail': await getDocumentParameter<UsersRecord>(
              data, 'userEmail', UsersRecord.serializer),
          'userDisplay': await getDocumentParameter<UsersRecord>(
              data, 'userDisplay', UsersRecord.serializer),
          'userPhoto': getParameter<DocumentReference>(data, 'userPhoto'),
        },
      ),
};
