...
class AppStateNotifier extends ChangeNotifier {
  ...
  void update(CarpoolFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/editProfile',
          asyncParams: {
            'userEmail': getDoc(['users'], UsersRecord.serializer),
            'userDisplay': getDoc(['users'], UsersRecord.serializer),
          },
